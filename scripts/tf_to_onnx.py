...
# Example usage
model_path = '4xSPANkendata_fp32.onnx'  # Path to your ONNX model
image_path = 'img3.jpg'              # Path to the input image
output_path = 'upscaled_image.jpg'          # Path to save the upscaled image
